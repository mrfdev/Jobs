...
```
,-- Zrips CMI 9.3.1.3 or newer with CMI Economy enabled from SpigotMC.
|   '- https://www.spigotmc.org/resources/3742/
|
|-- Zrips CMI Library 1.2.4.5 or newer from SpigotMC
...
|
|-- Zrips Jobs-Reborn 5.1.2.0 or newer from SpigotMC.
|   '- https://www.spigotmc.org/resources/4216/
| 
|-- LuckPerms 5.4.60 or newer from SpigotMC.
