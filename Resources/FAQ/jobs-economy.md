...
```
,-- Zrips CMI 9.2.0.4 or newer with CMI Economy enabled from SpigotMC.
|   '- https://www.spigotmc.org/resources/3742/
|
|-- Zrips CMI Library 1.2.0.3 or newer from SpigotMC
...
|
|-- Zrips Jobs-Reborn 5.1.0.0 or newer from SpigotMC.
|   '- https://www.spigotmc.org/resources/4216/
| 
|-- LuckPerms 5.4.30 or newer from SpigotMC.
|   '- https://www.spigotmc.org/resources/28140/
|
`-- Spigot 1.19 (or Paper 1.19) or newer.
